...
scCHANTS_pb!mc <- subset(scCHANTS, subset = PBMC_or_T == "PBMC")
length(Cells(scCHANTS_pb!mc@assays$RNA))
length(Cells(scCHANTS_pb!mc@assays$HTO))
length(Cells(scCHANTS_pb!mc@assays$ADT))
