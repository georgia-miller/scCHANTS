...
HTOHeatmap(scCHANTS, assay = "HTO", classification = "classification")
...
# plot counts
VlnPlot(scCHANTS, features = colnames(seurat_obj[["HTO"]]), assay = "HTO")
...
markers <- c("CD3D", "CD3E", "CD3G", "TRAC", # both CD4 and CD8 T cells
...
pca12
# ggsave("PCA_sample_id_umap.png", plot = pca12, device = png, height = 10, width =13, unit = "cm", path = paste0(file_path, "/T_plots/PCA/") )

pca13 <- DimPlot(scCHANTS_t, reduction = "umap", group.by = "timepoint")
pca13
# ggsave("PCA_timepoint_umap.png", plot = pca13, device = png, height = 10, width =11, unit = "cm", path = paste0(file_path, "/T_plots/PCA/") )
