---
title: "script_2.1_055_demux_qc_20250805"
author: "GKM"
date: "2025-08-11"
output:
  html_document:
...
This script is a pipeline to do pre-processing for 20250805_run1 samples from donor 055. It will explore the seurat file, plot and save various plots and determine the QC metrics for both PBMC and T cell sorted populations. 
...
scCHANTS_055_data <- Read10X(data.dir = "/Users/k2477939/Library/CloudStorage/OneDrive-King\'sCollegeLondon/General\ -\ Laboratory\ of\ Molecular\ Immunotherapy\ and\ Antibiotics/Data/Georgia\ Miller/scCHANTS/20250805_run1/20250805_run1_055", gene.column=2)
...
p <- RidgePlot(scCHANTS_055, assay = "HTO", features = rownames(scCHANTS_055[["HTO"]])[1:2], ncol = 2, group.by = "HTO_classification")
# ggsave("HTO_1to2_ridgeplot_055.png", plot = p, device = png, height = 45, width = 30, unit = "cm", path = paste0(file_path, "/demultiplex_055/") )
p
