...
## Dotplots
```{r}
marker_genes_s <- c("CCR7", "SELL", "TCF7", "IL2", "TNF", "IL4R", "CXCR6", "ITGA1", "CCL5", "GZMB", "GZMK", "FOXP3", "IL2RA", "CTLA4", "IFNG", "CCL4", "CCL3", "PRF1", "NKG7")

d7 <- pheatmap(scCHANTS_pbmc, features = marker_genes_s, assay = "RNA", group.by = "seurat_clusters", cols = c("lightgrey", "blue")) +
  coord_flip() +
  ggtitle("scCHANTS T subtypes by S marker exp run1")
d7

#ggsave("clusters_by_BMmarkerexp_dotplot.pdf", plot = d7, device = pdf, width = 20, height = 14, unit = "cm", bg = "white", path = paste0(plot_path, "cell_types/") )
#ggsave("clusters_by_BMmarkerexp_dotplot.png", plot = d7, device = png, width = 20, height = 14, unit = "cm", bg = "white", path = paste0(plot_path, "cell_types/") )
```
